...
Public Class WebForm1
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Else
            ...
            Dim SQL As String = "SELECT * FROM erreserba, ostatu, erabiltzaile where erabiltzaile.id_erabiltzaile = erreserba.id_Erabiltzaile AND erreserba.id_Erreserba = ostatu.id_Ostatu and erabiltzaile.id_erabiltzaile = '" + erabiltzailea + "'"
